...
' Programmer:   john butenhoff <current date>
...
Public Class frmMain
    ...
    'Private Sub AssignDiscount(ByVal intNum As Integer, ByVal dblSub As Double, ByRef dblDisc As Double)
    '    Select Case intNum
    '        Case Is >= 6
    '            dblDisc = dblSub * 0.1
    '        Case Is >= 4
    ...
    'using a function instead of sub procedure
    Private Function GetDiscount(ByVal intnum As Integer, ByVal dblsub As Double) As Double
