...
Public Class frmMain
    ...
    Private Sub CancelKeys(sender As Object, e As KeyPressEventArgs) _
        Handles txtRooms.KeyPress,
            txtNights.KeyPress, txtAdults.KeyPress, txtChildren.KeyPress
    ...
    Private Sub txtRooms_Enter(sender As Object, e As EventArgs) _
        Handles txtRooms.Enter
        ' select contents when text box receives focus

        txtRooms.SelectAll()
    End Sub

    Private Sub txtNights_Enter(sender As Object, e As EventArgs) _
        Handles txtNights.Enter
        ' select contents when text box receives focus

        txtNights.SelectAll()
    End Sub

    Private Sub txtAdults_Enter(sender As Object, e As EventArgs) _
        Handles txtAdults.Enter
        ' select contents when text box receives focus

        txtAdults.SelectAll()
    End Sub

    Private Sub txtChildren_Enter(sender As Object, e As EventArgs) _
        Handles txtChildren.Enter
        ' select contents when text box receives focus
